...
MiscTab:AddButton({
	...
	Callback = function()
		...
		wait(0.1)
		game:GetService("Workspace")["__THINGS"].Pets:Destroy()
		wait(0.1)
...
MiscTab:AddButton({
	...
	Callback = function()
		wait(0.2)
		game:GetService("Workspace").Map["2 | Colorful Forest"]:Destroy()
		wait(0.1)
		game:GetService("Workspace").Map["3 | Castle"]:Destroy()
		wait(0.1)
		game:GetService("Workspace").Map["4 | Green Forest"]:Destroy()
